...
func parsedNodeFromSingBoxOutboundMap(outbound map[string]any, raw json.RawMessage) (ParsedNode, string, SkippedEntryDetail) {
...
func missingSingBoxOutboundRequiredField(nodeType string, outbound map[string]any, node ParsedNode) bool {
	switch nodeType {
	case "tor":
